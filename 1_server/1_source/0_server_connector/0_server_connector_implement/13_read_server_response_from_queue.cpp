...
void server_connector::read_server_response_from_queue()
{
    while (true)
    {
        ...
        message_block* request_message_block = server_response_message_block.second;
        ...
        // send_to_client(server_response_message_block->first, server_response_message_block->second);
